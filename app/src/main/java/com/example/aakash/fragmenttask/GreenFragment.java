 ...
 */
public class GreenFragment extends Fragment implements RedFragment.ActivityCommunicator {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        btn = view.findViewById(R.id.fragment_btn_green);
        btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                activityCommunicator.passDatatoActivity("Green");
            }
        });
    }
